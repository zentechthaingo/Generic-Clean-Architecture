...
import com.grability.rappitendero.domain.executors.PostExecutionThread;
import com.grability.rappitendero.domain.executors.ThreadExecutor;
import com.grability.rappitendero.domain.models.mappers.ModelDataMapper;
...
public class GenericUseCase {
     ...
     */
    @SuppressWarnings("unchecked")
    public void uploadFile(@NonNull Subscriber UseCaseSubscriber, String url, File file, @NonNull Class presentationClass,
                           Class domainClass, Class dataClass, boolean persist) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void uploadFile(@NonNull UploadRequest uploadRequest) {
    ...
    public <T> void getDataFromJson(@NonNull Subscriber<? super T> subscriber, @NonNull Context context, String assetName,
