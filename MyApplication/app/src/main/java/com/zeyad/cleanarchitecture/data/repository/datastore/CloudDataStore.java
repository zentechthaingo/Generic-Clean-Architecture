...
public class CloudDataStore implements DataStore {
    ...
    // TODO: 6/05/16 Test!
    public static Func1<Object, Boolean> queuePost = object -> {
        ...
        context.startService(new Intent(context, GenericNetworkQueueIntentService.class)
//                .putExtra(GenericNetworkQueueIntentService.JOB_TYPE, GenericNetworkQueueIntentService.POST)
//                .putExtra(GenericNetworkQueueIntentService.POST_OBJECT, mGson.toJson(object)))
...
//        return false;
    ...
    // TODO: 6/05/16 Test!
    public static final Func1<List, Boolean> queueDeleteCollection = list -> {
        Bundle extras = new Bundle();
