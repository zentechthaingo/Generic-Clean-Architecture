...
//                });
//        try {
//            gsonBuilder.registerTypeAdapter(Class.forName("io.realm.UserRealmProxy"), new UserEJsonSerializer());
...
//                .addConverterFactory(WireConverterFactory.createById())
//                .addConverterFactory(ProtoConverterFactory.createById())
